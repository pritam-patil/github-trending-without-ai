...
<!-- TRENDING:START -->
*Last updated: **2026-09-11 16:13 UTC** — repos with >100 stars, active in the last 7 days, no AI keywords detected.*

| # | Repository | ⭐ Stars | Language | Description |
|--:|------------|--------:|----------|-------------|
| 1 | [public-apis/public-apis](https://github.com/public-apis/public-apis) | 478,910 | Python | A collective list of free APIs |
| 2 | [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | 455,311 | TypeScript | freeCodeCamp.org's open-source codebase and curriculum. Learn math, programming, and computer science for free. |
| 3 | [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) | 396,525 | Python | :books: Freely available programming books |
| 4 | [nilbuild/developer-roadmap](https://github.com/nilbuild/developer-roadmap) | 366,895 | TypeScript | Interactive roadmaps, guides and other educational content to help developers grow in their careers. |
| 5 | [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) | 318,527 | Unknown | A list of Free Software network services and web applications which can be hosted on your own servers |
| 6 | [practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning) | 282,966 | Python | Curated list of project-based tutorials |
| 7 | [react/react](https://github.com/react/react) | 250,039 | JavaScript | The library for web and native user interfaces. |
| 8 | [torvalds/linux](https://github.com/torvalds/linux) | 248,252 | C | Linux kernel source tree |
| 9 | [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) | 224,479 | Python | All Algorithms implemented in Python |
| 10 | [microsoft/vscode](https://github.com/microsoft/vscode) | 192,007 | TypeScript | Visual Studio Code |
| 11 | [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) | 190,190 | Batchfile | Open-source Windows and Office activator featuring HWID, Ohook, TSforge, and Online KMS activation methods, along with advanced troubleshoo… |
| 12 | [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) | 189,668 | Shell | 🙃 A delightful community-driven (with 2,500+ contributors) framework for managing your zsh configuration. Includes 300+ optional plugins (r… |
| 13 | [avelino/awesome-go](https://github.com/avelino/awesome-go) | 183,810 | Go | A curated list of awesome Go frameworks, libraries and software |
| 14 | [flutter/flutter](https://github.com/flutter/flutter) | 178,893 | Dart | Flutter makes it easy and fast to build beautiful apps for mobile and beyond |
| 15 | [github/gitignore](https://github.com/github/gitignore) | 175,713 | Unknown | A collection of useful .gitignore templates |
| 16 | [twbs/bootstrap](https://github.com/twbs/bootstrap) | 174,757 | MDX | The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web. |
| 17 | [Genymobile/scrcpy](https://github.com/Genymobile/scrcpy) | 149,391 | C | Display and control your Android device |
| 18 | [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) | 143,825 | Rust | A modern GUI client based on Tauri, designed to run in Windows, macOS and Linux for tailored proxy experience |
...
| 23 | [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) | 137,128 | HTML | A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev |
| 24 | [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | 131,609 | TypeScript | Virtual whiteboard for sketching hand-drawn like diagrams |
...
| 26 | [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) | 127,333 | Go | Production-Grade Container Scheduling and Management |
...
| 28 | [shadcn-ui/ui](https://github.com/shadcn-ui/ui) | 123,573 | TypeScript | A set of beautifully-designed, accessible components and a code distribution platform. Works with your favorite frameworks. Open Source. Op… |
| 29 | [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) | 123,185 | Rust | An open-source remote desktop application designed for self-hosting, as an alternative to TeamViewer. |
| 30 | [electron/electron](https://github.com/electron/electron) | 122,993 | C++ | :electron: Build cross-platform desktop apps with JavaScript, HTML, and CSS |
| 31 | [nodejs/node](https://github.com/nodejs/node) | 121,583 | JavaScript | Node.js JavaScript runtime ✨🐢🚀✨ |
| 32 | [rust-lang/rust](https://github.com/rust-lang/rust) | 118,388 | Rust | Empowering everyone to build reliable and efficient software. |
| 33 | [godotengine/godot](https://github.com/godotengine/godot) | 116,970 | C++ | Godot Engine – Multi-platform 2D and 3D game engine |
| 34 | [2dust/v2rayN](https://github.com/2dust/v2rayN) | 115,914 | C# | A GUI client for Windows, Linux and macOS, support Xray and sing-box and others |
| 35 | [mrdoob/three.js](https://github.com/mrdoob/three.js) | 115,409 | JavaScript | JavaScript 3D Library. |
| 36 | [immich-app/immich](https://github.com/immich-app/immich) | 113,841 | TypeScript | High performance self-hosted photo and video management solution. |
| 37 | [jaywcjlove/awesome-mac](https://github.com/jaywcjlove/awesome-mac) | 113,560 | Swift |  This project is dedicated to collecting high-quality macOS software and organizing them systematically by different categories for easy s… |
| 38 | [tauri-apps/tauri](https://github.com/tauri-apps/tauri) | 111,000 | Rust | Build smaller, faster, and more secure desktop and mobile applications with a web frontend. |
| 39 | [microsoft/TypeScript](https://github.com/microsoft/TypeScript) | 110,999 | Go | TypeScript is a superset of JavaScript that compiles to clean JavaScript output. |
| 40 | [fatedier/frp](https://github.com/fatedier/frp) | 109,343 | Go | A fast reverse proxy to help you expose a local server behind a NAT or firewall to the internet. |
...
| 50 | [microsoft/playwright](https://github.com/microsoft/playwright) | 95,976 | TypeScript | Playwright is a framework for Web Testing and Automation. It allows testing Chromium, Firefox and WebKit with a single API. |
| 51 | [oven-sh/bun](https://github.com/oven-sh/bun) | 95,941 | Rust | Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one |
